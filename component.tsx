...
import componentStrings = require("ojL10n!./resources/nls/my-test2-strings");
  ...
  implements Composite.ViewModel<Composite.PropertiesType>
{
  ...
  constructor(context: Composite.ViewModelContext<Composite.PropertiesType>) {
    ...
    this.messageText = ko.observable(
      this.properties.message ? this.properties.message : "Hello from my-test2"
    );

    this.res = componentStrings["my-test2"];
